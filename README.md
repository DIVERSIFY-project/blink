...
Then, when everything is set up, you can start Blink and synthesize a new browsing environment by launching the **mainHost.py** script located at the root of your own Blink directory (Python 3 and Python3-numpy required).  
